...
const HomeView: React.FC = () => {
  ...
  return (
    <div className="main-layout text-slate-900" style={{ background: 'linear-gradient(135deg, hsl(175,45%,92%) 0%, hsl(175,32%,95%) 35%, hsl(175,18%,97%) 65%, hsl(0,0%,99%) 100%)' }}>
      <Header
        showActions={true}
              ...
              {hasChats && !isResizing && (
                <div className="mb-8">
                  <div className="flex items-center justify-between mb-3">
                    <p className="text-xs font-semibold text-slate-500 uppercase tracking-widest">Recent Sessions</p>
                    <button
                      onClick={() => setIsChatHistoryOpen(true)}
                      className="text-xs text-teal-700 hover:text-teal-800 transition-colors"
                    >
                      View all
                    </button>
                  </div>
              ...
              <footer className="mt-auto pt-6 pb-4 border-t border-slate-200">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1">
                    <a href="https://cyoda.com" target="_blank" rel="noopener noreferrer" className="p-1.5 rounded-md text-slate-400 hover:text-slate-600 hover:bg-slate-100 transition-colors" title="cyoda.com">
                      <img src={LogoSmall} alt="Cyoda" className="w-4 h-4" />
                    </a>
                    <a href="https://github.com/Cyoda-platform/cyoda-go" target="_blank" rel="noopener noreferrer" className="p-1.5 rounded-md text-slate-400 hover:text-slate-600 hover:bg-slate-100 transition-colors" title="GitHub">
                      <Github size={14} />
                    </a>
                    <a href="https://www.linkedin.com/company/cyoda" target="_blank" rel="noopener noreferrer" className="p-1.5 rounded-md text-slate-400 hover:text-slate-600 hover:bg-slate-100 transition-colors" title="LinkedIn">
                      <Linkedin size={14} />
                    </a>
<a href="https://discord.com/invite/95rdAyBZr2" target="_blank" rel="noopener noreferrer" className="p-1.5 rounded-md text-slate-400 hover:text-slate-600 hover:bg-slate-100 transition-colors" title="Discord">
                      <svg width="14" height="14" viewBox="0 0 71 55" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
