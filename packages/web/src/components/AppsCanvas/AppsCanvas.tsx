...
import type { UIWorkflowData, UIStateData, UITransitionData, StateDefinition, TransitionDefinition, WorkflowConfiguration } from '../WorkflowCanvas/types/workflow';
import { StateNode } from '../WorkflowCanvas/Canvas/StateNode';
import { TransitionNode } from '../WorkflowCanvas/Canvas/TransitionNode';
import { TransitionEdge } from '../WorkflowCanvas/Canvas/TransitionEdge';
import { LoopbackEdge } from '../WorkflowCanvas/Canvas/LoopbackEdge';
import { WorkflowJsonEditor } from '../WorkflowCanvas/Editors/WorkflowJsonEditor';
import { generateTransitionId, generateLayoutTransitionId, migrateLayoutTransitionId, validateTransitionExists, parseLayoutTransitionId, parseTransitionId } from '../WorkflowCanvas/utils/transitionUtils';
import { autoLayoutWorkflow, canAutoLayout } from '../WorkflowCanvas/utils/autoLayout';
import { useTheme } from '../WorkflowCanvas/hooks/useTheme';
import { getAvailableThemes, COLOR_PALETTES } from '../WorkflowCanvas/themes/colorPalettes';
...
export const AppsCanvas: React.FC<WorkflowCanvasProps> = (props) => {
  return (
    <ReactFlowProvider>
...
// Export as WorkflowCanvas for backward compatibility (since this is a copy)
export const WorkflowCanvas = AppsCanvas;
