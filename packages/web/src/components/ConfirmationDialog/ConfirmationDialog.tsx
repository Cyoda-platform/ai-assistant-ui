      ...
      footer={
        <div className="flex justify-end gap-3">
          <Button
            ...
            className="min-w-[120px] h-10 font-medium !text-white"
          >
            I Accept
          </Button>
        </div>
      ...
      <div className="py-2">
        <p className="text-sm !text-white leading-relaxed mb-3">
          ...
          <a
            ...
            className="!text-white hover:!text-gray-200 font-medium underline decoration-1 underline-offset-2 transition-colors"
          >
            Terms & Conditions
          </a>
          {' '}and{' '}
        ...
        <div className="flex items-start gap-2">
          ...
          />
          <label
            className="text-sm !text-white cursor-pointer select-none flex-1"
