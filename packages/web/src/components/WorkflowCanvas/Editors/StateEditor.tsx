      ...
      <div className="bg-gray-800 rounded-lg shadow-xl w-full max-w-md mx-4">
        ...
        <div className="flex items-center justify-between p-4 border-t border-gray-700">
          <div>
            {onDelete && (
              <button
                ...
                className="px-4 py-2 text-red-400 hover:bg-red-900/20 rounded-md transition-colors flex items-center space-x-2"
              >
                <Trash2 size={16} />
          ...
          <div className="flex space-x-2">
            <button
              onClick={onClose}
              className="px-4 py-2 text-gray-400 hover:bg-gray-700 rounded-md transition-colors"
            >
              Cancel
            </button>
            <button
